...
parser = argparse.ArgumentParser(description='Nexis snapshot finder')
...
parser.add_argument('-r', '--rpc_address',
    default='https://api.devnet.nexis.network', type=str,
...
help='Maximum snapshot download speed in megabytes - https://github.com/Nexis-Network/nexis-snapshot-finder/issues/11. Example: --max_download_speed 192')
...
parser.add_argument('--snapshot_path', type=str, default=".", help='The location where the snapshot will be downloaded (absolute path).'
                                                                     ' Example: /home/ubuntu/nexis/validator-ledger')
...
def download(url: str):
    ...
    try:
        # dirty trick with wget. Details here - https://github.com/Nexis-Network/nexis-snapshot-finder/issues/11
...
logger.info("https://github.com/Nexis-Network/nexis-snapshot-finder\n\n")
logger.info(f'{RPC=}\n'
